...
import { {{pascalCase name}} } from './{{dashCase name}}.schema';
...
export class {{pascalCase name}}Service {
  constructor(
    ...
    protected readonly model: Model<{{pascalCase name}} & Document>
  ) {}

  async findAll(model: MongooseQueryModel): Promise<{{pascalCase name}}[]> {
  ...
  async findOne(model: MongooseQueryModel): Promise<{{pascalCase name}}> {
  ...
  async insert(doc: Partial<{{pascalCase name}}>, session: ClientSession): Promise<any> {
