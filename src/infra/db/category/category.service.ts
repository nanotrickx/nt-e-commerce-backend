...
export class CategoryService {
  constructor(
    ...
    protected readonly model: Model<Category & Document>
  ) {}

  async findAll(model: MongooseQueryModel): Promise<Category[]> {
  ...
  async findOne(model: MongooseQueryModel): Promise<Category> {
  ...
  async insert(doc: Partial<Category>, session: ClientSession): Promise<any> {
