...
export class OrderItemService {
  constructor(
    ...
    protected readonly model: Model<OrderItem & Document>
  ) {}

  async findAll(model: MongooseQueryModel): Promise<OrderItem[]> {
  ...
  async findOne(model: MongooseQueryModel): Promise<OrderItem> {
  ...
  async insert(doc: Partial<OrderItem>, session: ClientSession): Promise<any> {
