...
export class WebhookService {
  constructor(
    @InjectModel('Webhook')
    protected readonly model: Model<Webhook & Document>
  ) {}

  async findAll(model: MongooseQueryModel): Promise<Webhook[]> {
  ...
  async findOne(model: MongooseQueryModel): Promise<Webhook> {
  ...
  async insert(doc: Partial<Webhook>, session: ClientSession): Promise<any> {
